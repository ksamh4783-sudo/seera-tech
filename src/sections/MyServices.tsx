...
const services: Service[] = [
  {
    ...
    description: 'حلول مراقبة متقدمة للفنادق والشركات تتيح المراقبة الفورية عن بُعد من أي مكان. أنظمة آمنة وموثوقة مع تسجيل فيديو عالي الجودة.',
    features: [
      'كاميرات IP و CCTV بدقة 4K و Full HD مع تسجيل 24/7',
      'متابعة حية من الهاتف والتابلت والكمبيوتر',
      'تحكم كامل في زوايا الكاميرات عن بعد (PTZ)',
      'تنبيهات فورية عند اكتشاف حركة أو دخول منطقة محظورة',
      'استضافة سحابية آمنة مع نسخ احتياطية تلقائية'
    ],
    color: 'cyan',
  ...
  {
    icon: Tv,
    title: 'صيانة الإلكترونيات والشاشات المتقدمة 📺',
    description: 'خدمات متخصصة لصيانة شاشات العرض الكبيرة واللوحات الإلكترونية. نقدم حلولاً سريعة وفعالة لضمان استمرارية عملك دون توقف.',
    features: [
      'صيانة شاشات LED و LCD بجميع الأحجام',
      'شحن الفلاشات وبرمجة البرامج الثابتة (Firmware)',
      'إصلاح أعطال الباور والألوان وجودة الصورة',
      'تركيب وإزالة قطع الغيار الأصلية مع ضمان',
      'صيانة فورية للمشاكل الطارئة (24 ساعة)'
    ],
    color: 'purple',
  ...
  {
    icon: Satellite,
    title: 'أنظمة الساتالايت المركزية 🛰️',
    description: 'حلول دش مركزي متطورة للفنادق والعمارات السكنية. نوفر لك قنوات عالية الجودة تصل إلى جميع الغرف والمناطق بتوزيع موحد.',
    features: [
      'تركيب أنظمة دش مركزية للفنادق والمجمعات السكنية',
      'توزيع الإشارة إلى عشرات الغرف من مصدر واحد',
      'برمجة الرسيفرات (HD/4K) بأحدث الترددات والقنوات',
      'تحديث دوري للملفات وضمان جودة البث العالية',
      'صيانة وحل المشاكل الفنية بسرعة (24/7)'
    ],
    color: 'green',
