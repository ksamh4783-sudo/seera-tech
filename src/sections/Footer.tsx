import { Code2, Linkedin, Facebook, Mail, ArrowUp } from 'lucide-react';
...
const services = [
  'أنظمة المراقبة (CCTV & IP)',
  'برمجة سيرفرات مايكروتك',
  'صيانة الشاشات والإلكترونيات',
  'أنظمة دش مركزي للفنادق',
  'تجهيز شبكات الهوت سبوت',
  'أنظمة كاشير وإدارة مخازن'
];

const socialLinks = [
  { icon: Linkedin, href: 'https://www.linkedin.com/in/sameh-rizk-iskander-760054173', label: 'LinkedIn' },
  { icon: Facebook, href: 'https://www.facebook.com/share/1BGWkrfUmr/', label: 'Facebook' },
  { icon: Mail, href: 'mailto:samh_rizk2007@yahoo.com', label: 'Yahoo Mail' }
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-white/60 text-sm leading-relaxed mb-6 text-right">
              خبرة في الأنظمة الأمنية والشبكات وصيانة الإلكترونيات بالإسكندرية. نقدم حلولاً متكاملة لتأمين وإدارة عملك بأحدث التقنيات.
            </p>
            {/* Social Links */}
          ...
          <div className="text-right">
            ...
            <p className="text-white/60 text-sm mb-4">
              الإسكندرية - منطقة السيوف وكافة أرجاء المحافظة
            </p>
            <div className="flex flex-col gap-2">
               <span className="text-cyan-400 text-sm">متوفرون لخدمتكم 24/7</span>
               <span className="text-white/40 text-xs mt-2 italic">دعم فني متاح باللغة الروسية</span>
            </div>
          </div>
        </div>

        {/* Bottom Bar */}
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row-reverse items-center justify-between gap-4">
          <p className="text-white/40 text-sm">
            © 2026 سيرا للحلول التقنية. جميع الحقوق محفوظة
          </p>
